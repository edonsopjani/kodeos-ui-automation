...
public enum BuildingPanel implements PageObjects {
    ...
    clickBuilding(PageObjectUtils.LocatorType.XPATH, "//label[contains(text(), 'Assign Buildings')]/..//td//*[contains(text(), 'KODE Labs')]"),
    ...
    ClickUpdateRole(PageObjectUtils.LocatorType.XPATH, "//i[@mattooltip='Update User Role']"),
